...
DRIVE 2 — 18:11Z — sandbox at 5e17be3 (#174 follow-up head), ORIGIN_STAMPED=1: PASS — 61 checks, 0 failed, 14 controls, first run. P17 origin at pod2 and at pod1's echo = 'orch:pod1:<pub>'; P18b forged origin 'orch:admin' delivered as 'orch:orch:admin' with from unchanged — the stamp is truthful only in its FIRST segment; the remainder is peer-asserted (doc sentence for §3, candidate amendment on #174). Run log: f2-verify/run-f4-5e17be3.jsonl.
